    ...
    <div class="receipt-container">
        ...
        <div class="amount-section">
            <div class="detail-row">
                ...
                <span class="detail-value">₱{{ number_format($transaction->quotation_amount, 2, '.', ',') }}</span>
            </div>
            @if($transaction->total_penalties && $transaction->total_penalties > 0)
            <div class="detail-row">
                <span class="detail-label">Penalties:</span>
                <span class="detail-value">₱{{ number_format($transaction->total_penalties, 2, '.', ',') }}</span>
            </div>
            @endif
            <div class="total-amount">
                Total: ₱{{ number_format($transaction->quotation_amount + ($transaction->total_penalties ?? 0), 2, '.', ',') }}
            </div>
        </div>
