...
export default function AlternativeARMeasurementScreen() {
  ...
  // Simple back navigation without router dependencies
  const handleBackPress = () => {
    console.log('Back button pressed - navigation handled by parent component');
    // This will be handled by the parent component or navigation wrapper
  };
  ...
  if (!permission?.granted) {
    return (
      <NavigationWrapper onBackPress={handleBackPress}>
