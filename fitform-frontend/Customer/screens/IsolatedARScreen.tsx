...
interface ARSessionState {
  ...
  measurements: LocalBodyMeasurements | null;
  error: string | null;
}
...
export default function IsolatedARScreen() {
  ...
  // Simple back navigation without any dependencies
  const handleBackPress = () => {
    console.log('Back button pressed - isolated navigation');
    // Simple alert for now - no navigation dependencies
